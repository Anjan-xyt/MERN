...
postRouter.route("/create-post").post(upload.fields([{ name: "post_img", maxcount: 1 }]), createPost);
...
postRouter.route("/:post_id/update-post-details").patch(updatePostDetails);
