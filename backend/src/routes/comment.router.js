...
import deleteAllLikesOfComment from "../middlewares/deleteAllLikesOfComment.js";
...
commentRouter.route("/:post_id/:comment_id/delete-comment").delete(deleteAllLikesOfComment, deleteComment);
